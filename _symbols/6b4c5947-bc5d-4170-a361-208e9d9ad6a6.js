...
function create_each_block(ctx) {
	...
	return {
		...
		h() {
			attr(li, "class", "svelte-panjl8");
			attr(a, "class", "link svelte-panjl8");
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(ul, "class", "menu-bar svelte-panjl8");
			attr(header, "class", "nav svelte-panjl8");
		},
		m(target, anchor) {
