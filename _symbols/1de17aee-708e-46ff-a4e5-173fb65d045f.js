// Contact Form - Updated February 28, 2024
function noop() { }
function run(fn) {
    return fn();
}
...
function create_else_block(ctx) {
	...
	return {
		...
		h() {
			attr(span, "class", "svelte-1ibv8i4");
			...
			attr(input, "class", "svelte-1ibv8i4");
			attr(label, "class", "svelte-1ibv8i4");
		},
		m(target, anchor) {
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			attr(span, "class", "svelte-1ibv8i4");
			attr(textarea, "class", "svelte-1ibv8i4");
			attr(label, "class", "svelte-1ibv8i4");
		},
		m(target, anchor) {
			insert_hydration(target, label, anchor);
...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			t4 = claim_text(button_nodes, /*submit_label*/ ctx[3]);
		...
		h() {
			...
			attr(div0, "class", "body svelte-1ibv8i4");
			attr(div1, "class", "content svelte-1ibv8i4");
			attr(button, "class", "button svelte-1ibv8i4");
			attr(button, "type", "submit");
			attr(form, "class", "svelte-1ibv8i4");
			attr(section, "class", "section-container svelte-1ibv8i4");
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*subheading*/ 4) div0.innerHTML = /*subheading*/ ctx[2];
			if (dirty & /*inputs*/ 1) {
			...
			if (dirty & /*submit_label*/ 8) set_data(t4, /*submit_label*/ ctx[3]);
		},
		i: noop,
		o: noop,
		d(detaching) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('submit_label' in $$props) $$invalidate(3, submit_label = $$props.submit_label);
	};

	return [inputs, heading, subheading, submit_label, props, social];
}
